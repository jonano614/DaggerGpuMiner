...
namespace XDag
{
    ...
    public:
        ...
        void Append(bigint const& _t) { _sstr << EthNavy << _t << EthReset; }
        void Append(u256 const& _t) { _sstr << EthNavy << _t << EthReset; }
        void Append(u160 const& _t) { _sstr << EthNavy << _t << EthReset; }
        ...
        void Append(bytes const& _t) { _sstr << EthYellow "%" << ToHex(_t) << EthReset; }
        void Append(bytesConstRef _t) { _sstr << EthYellow "%" << ToHex(_t) << EthReset; }
